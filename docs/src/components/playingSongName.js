...
// 1. Display name of currently playing song in the DOM
...
const displayPlayingSongName = (playingSongIndex) => {
  playingSongName.innerText = localSongsArray[playingSongIndex].songName;
};

const removePlayingSongName = () => {
  playingSongName.innerText = '';
};

export { displayPlayingSongName, removePlayingSongName };